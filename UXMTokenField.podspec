...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of UXMTokenField."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/UXMTokenField"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Chris Anderson" => "hi@chrisanderson.io" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/UXMTokenField.git", :tag => s.version.to_s }
